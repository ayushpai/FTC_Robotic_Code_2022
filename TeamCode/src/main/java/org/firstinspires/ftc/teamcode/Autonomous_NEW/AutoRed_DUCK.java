...
//@Config
@Autonomous(name = "RED DUCK AUTO", group = "Autonomous")
public class AutoRed_DUCK extends LinearOpMode {
    ...
    private void level3Auto(){
        ...
        wait(300);
        wait(11000); // 3839 delay
        strafeDirection(325, 0.7, 1650, true); // strafe left towards shipping hub
        strafeDirectionLIFT(270, 0.35, 300, true, 3, RobotConstants.rackRed);  //400 low //450 mid //480 high
        wait(1500);
        robot.clawServo.setPosition(RobotConstants.clawOpen);
        wait(1000);
        resetLiftExtension();
        wait(1000);
        strafeDirection(90, 0.6, 1200, true);
        strafeDirection(0, 0.5, 2200, true);
    }
