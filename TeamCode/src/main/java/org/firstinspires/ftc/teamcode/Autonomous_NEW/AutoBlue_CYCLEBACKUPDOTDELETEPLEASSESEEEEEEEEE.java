...
//@Config
@Autonomous(name = "RED 4 CYCLE", group = "Autonomous")
public class AutoBlue_CYCLEBACKUPDOTDELETEPLEASSESEEEEEEEEE extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        visionInit();
        wait(2000);
        if(pipeline.position.equals(AutoBlue_CYCLEBACKUPDOTDELETEPLEASSESEEEEEEEEE.FreightDetermination.FreightPosition.LEFT)){
            telemetry.addData("Position: ", "Left");
        }
        else if(pipeline.position.equals(AutoBlue_CYCLEBACKUPDOTDELETEPLEASSESEEEEEEEEE.FreightDetermination.FreightPosition.CENTER)){
            telemetry.addData("Position: ", "Center");
        }
        else if(pipeline.position.equals(AutoBlue_CYCLEBACKUPDOTDELETEPLEASSESEEEEEEEEE.FreightDetermination.FreightPosition.RIGHT)){
    ...
    private void level1Auto(){
        strafeDirection(243, 0.7 , 950, true, true, false, 1); // go to hub
        clawOpen(true, true);
        wait(200);
        ...
        strafeDirection(355, 1, 400,  false, false,false, 0); // go forward fast
        intake(true, false);
        clawOpen(true, false);
        strafeDirection(355, 1, 600,  true, false,false, 0); // go forward fast
        strafeDirection(355, 0.25, 850,  true, false,true,  0); // go forward until intake spikes

        goToWhiteLine(185);
        goBackToStartingPosition();
        strafeDirection(114, 0.8 , 1000, true, true, false, 3); // go to hub
        clawOpen(true, false);
        wait(400);
        clawOpen(false, false);
        intake(false, true);
        strafeDirection(294, 1, 985, true, false, true, false, 0); // go back to wall


        /** Cycle 3**/
        strafeDirection(270, 1, 50, false, false,false, 0); // line up w/ wall
        strafeDirection(355, 1, 700,  false, false,false, 0); // go forward fast
        intake(true, false);
        clawOpen(true, false);
        strafeDirection(355, 1, 700,  true, false,false, 0); // go forward fast
        strafeDirection(10, 0.5, 900,  true, false, true, 0); // go forward until intake spikes
        wait(200);
        strafeDirection(180, 1, 250, true, false, false, 0);
        strafeDirection(260, 1, 200, true, true, false, false, 0);
        ...
        intake(true, false);
        clawOpen(true, false);
        strafeDirection(355, 1, 300,  true, false,false, 0); // go forward fast
        strafeDirection(60, 0.5, 900,  true, false, true, 0); // go forward until intake spikes
        wait(200);
        if(timer.seconds() <= 24){
            strafeDirection(180, 1, 250, true, false, false, 0);
            strafeDirection(260, 1, 555, true, true, false, false, 0);
            goToWhiteLine(190);
            goBackToStartingPosition();
            strafeDirection(114, 0.8 , 1000, true, true, false, 3); // go to hub
            clawOpen(true, false);
    ...
    private void level2Auto(){
        strafeDirection(114, 1 , 1050, true, true, false, 2); // go to hub
        wait(300);
        clawOpen(true, false);
        wait(350);
        clawOpen(false, false);
        ...
        intake(true, false);
        clawOpen(true, false);
        strafeDirection(355, 1, 500,  true, false,false, 0); // go forward fast
        strafeDirection(355, 0.25, 850,  true, false,true,  0); // go forward until intake spikes
        ...
        intake(true, false);
        clawOpen(true, false);
        strafeDirection(355, 1, 400,  true, false,false, 0); // go forward fast
        strafeDirection(60, 0.5, 900,  true, false, true, 0); // go forward until intake spikes
        wait(200);
        if(timer.seconds() <= 24){
            strafeDirection(180, 1, 250, true, false, false, 0);
