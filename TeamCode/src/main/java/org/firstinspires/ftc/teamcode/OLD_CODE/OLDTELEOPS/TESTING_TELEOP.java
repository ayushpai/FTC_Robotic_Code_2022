...
@TeleOp(name = "TESTING DO NOT USE" , group = "Teleop")
//@Config
public class TESTING_TELEOP extends OpMode {
    ...
    public void loop() {
       ...
       // setDBT();
        ...
        if (robot.magnet.getState()) {
            dashboardTelemetry.addData("Digital Touch", "Lift Up");
            dashboardTelemetry.update();
        } else {
            dashboardTelemetry.addData("Digital Touch", "Lift Down");
    ...
    private void setDBT(){
        ...
        dashboardTelemetry.addData("Claw Encoder", robot.rackAndPinionMotor.getCurrentPosition());
