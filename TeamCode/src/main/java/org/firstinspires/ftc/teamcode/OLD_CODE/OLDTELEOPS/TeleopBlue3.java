...
//@TeleOp(name = "Teleop DASHBOARD" , group = "Teleop")
//@Config
public class TeleopBlue3 extends OpMode {
    ...
    public void loop() {
        ...
        if (robot.magnet.getState() == true) {
            dashboardTelemetry.addData("Digital Touch", "Not Pressed");
        } else {
            dashboardTelemetry.addData("Digital Touch", "Pressed");
        }
