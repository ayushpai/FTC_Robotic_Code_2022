...
@TeleOp(name = "BLUE ALLIANCE SPECIFIC", group = "Teleop")
@Config
public class Teleop_BLUE_ALLIANCE_SPECIFICOLD extends OpMode {
    ...
    public void loop() {
        ...
        robot.duckMotor.setPower(gamepad2.right_trigger *1.2);
        if(leftBumper1){
    ...
    private void capping(){
        ...
        if(gamepad1.dpad_left){
            robot.horizontalTurret.setPosition(0.56);
        }
        else if(gamepad1.dpad_right){
            robot.horizontalTurret.setPosition(0.44);
        }
    ...
    private void driver2Controls(){
        ...
        if(dpadUp){
            ...
            if(robot.liftMotor.getCurrentPosition() < 750){ // close the claw just in case to not break it
                ...
                moveExtension2(RobotConstants.rackBlue +150, RobotConstants.rackSpeed, 3); // move extension out once the lift is high enough
            }
        }
    ...
    public void toggles(){
        ...
        capMode = toggle(gamepad1.x, capMode, capModeDOUBLECLICK)[0];
        capModeDOUBLECLICK = toggle(gamepad1.x, capMode, capModeDOUBLECLICK) [1];
    }
