...
//@Config
@Autonomous(name = "RED CYCLE AUTO", group = "Autonomous")
public class AutoRed_CYCLE extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        visionInit();
        wait(2000);
        if(pipeline.position.equals(AutoRed_CYCLE.FreightDetermination.FreightPosition.LEFT)){
            telemetry.addData("Position: ", "Left");
        }
        else if(pipeline.position.equals(AutoRed_CYCLE.FreightDetermination.FreightPosition.CENTER)){
            telemetry.addData("Position: ", "Center");
        }
        else if(pipeline.position.equals(AutoRed_CYCLE.FreightDetermination.FreightPosition.RIGHT)){
        ...
        strafeDirection(243, 1 , 1000, true, true, false, 3); // go to hub
        wait(100);
        clawOpen(true, false);
        wait(200);
        clawOpen(false, false);
        intake(false, true);
        strafeDirection(70, 0.8, 985, true, false, true, false, 0); // go back to wall


        /** Cycle 2**/
        strafeDirection(90, 1, 50, false, false,false, 0); // line up w/ wall
        strafeDirection(5, 1, 200,  false, false,false, 0); // go forward fast
        intake(true, false);
        clawOpen(true, false);
        strafeDirection(5, 1, 700,  true, false,false, 0); // go forward fast
        strafeDirection(5, 0.25, 850,  true, false,true,  0); // go forward until intake spikes

        goToWhiteLine(175);
        goBackToStartingPosition();
        strafeDirection(249, 1 , 1000, true, true, false, 3); // go to hub
        clawOpen(true, false);
        wait(400);
        clawOpen(false, false);
        intake(false, true);
        ...
        clawOpen(true, false);
        strafeDirection(5, 1, 700,  true, false,false, 0); // go forward fast
        strafeDirection(350, 0.5, 900,  true, false, true, 0); // go forward until intake spikes
        wait(200);
        moveLiftLow(180, 250);
        moveLiftLow(110, 200);
        goToWhiteLine(170);
        goBackToStartingPosition();
        strafeDirection(248, 1 , 1000, true, true, false, 3); // go to hub
        clawOpen(true, false);
        wait(200);
        clawOpen(false, false);
        intake(false, true);
        ...
        if(timer.seconds() <= 28){
            ...
            strafeDirection(90, 1, 50, false, false, false, 0); // line up w/ wall
            intake(true, false);
            strafeDirection(5, 1, 1500,  true, false, false, 0); // go forward fast
            clawOpen(true, false);
    ...
    private void level1Auto(){
        strafeDirection(245, 0.7 , 950, true, true, false, 1); // go to hub
        clawOpen(true, true);
        wait(200);
        clawOpen(false, false);
        resetLiftExtension(true); // reset the lift and extension
        intake(false, true);
        strafeDirection(70, 0.8, 985, true, false,false, 0); // go back to wall
        ...
        goToWhiteLine(175);
        goBackToStartingPosition();
        strafeDirection(249, 1 , 1050, true, true, false, 3); // go to hub
        clawOpen(true, false);
        wait(400);
        clawOpen(false, false);
        intake(false, true);
        ...
        if(timer.seconds() <= 24) {
            ...
            clawOpen(true, false);
            strafeDirection(5, 1, 700, true, false, false, 0); // go forward fast
            strafeDirection(350, 0.2, 900, true, false, true, 0); // go forward until intake spikes
            wait(200);
            moveLiftLow(180, 250);
            moveLiftLow(110, 200);
            goToWhiteLine(170);
            goBackToStartingPosition();
            strafeDirection(248, 1, 1050, true, true, false, 3); // go to hub
            clawOpen(true, false);
            wait(400);
            clawOpen(false, false);
            intake(false, true);
            ...
            intake(true, false);
            clawOpen(true, false);
            strafeDirection(5, 1, 900, true, false, false, 0); // go forward fast
            /*strafeDirection(320, 0.22, 1000, true, false, true, 0); // go forward until intake spikes
            wait(200);
            if (timer.seconds() <= 24) {
                moveLiftLow(180, 250);
                moveLiftLow(100, 555);
    ...
    private void level2Auto(){
        strafeDirection(243, 1 , 1050, true, true, false, 2); // go to hub
        wait(300);
        clawOpen(true, false);
        wait(350);
        clawOpen(false, false);
    ...
    private void level3Auto(){
        strafeDirection(243, 1 , 1050, true, true, false, 3); // go to hub
        wait(100);
        clawOpen(true, false);
        wait(200);
        clawOpen(false, false);
        intake(false, true);
        strafeDirection(294, 0.8, 985, true, false, true, false, 0); // go back to wall


        /** Cycle 2**/
        strafeDirection(270, 1, 50, false, false,false, 0); // line up w/ wall
        ...
        strafeDirection(355, 0.45, 850,  true, false,true,  0); // go forward until intake spikes

        goToWhiteLine(185);
        goBackToStartingPosition();
        strafeDirection(114, 1 , 1050, true, true, false, 3); // go to hub
        clawOpen(true, false);
        wait(400);
        clawOpen(false, false);
        intake(false, true);
        ...
        if(timer.seconds() <= 24) {
            ...
            clawOpen(true, false);
            strafeDirection(5, 1, 700, true, false, false, 0); // go forward fast
            strafeDirection(350, 0.45, 900, true, false, true, 0); // go forward until intake spikes
            wait(200);
            moveLiftLow(180, 250);
            moveLiftLow(110, 200);
            goToWhiteLine(170);
            ...
            clawOpen(true, false);
            strafeDirection(5, 1, 900, true, false, false, 0); // go forward fast
            strafeDirection(320, 0.45, 1000, true, false, true, 0); // go forward until intake spikes
            wait(200);
            if (timer.seconds() <= 24) {
                moveLiftLow(180, 250);
                moveLiftLow(100, 555);
    ...
    private void depositFreight(){
        strafeDirection(245, 1 , 1050, true, true, false, 3); // go to hub
        clawOpen(true, true);
        wait(100);
        clawOpen(false, false);
        intake(true, false);
        strafeDirection(70, 1, 985, true, false, true,false, 0); // go back to wall
        clawOpen(true, false);
    }
            ...
            if(lift) {
                if(liftLevel == 2 || liftLevel == 3) {
                    ...
                    if (robot.liftMotor.getCurrentPosition() > 300) {
                        extensionOut(true, RobotConstants.rackRed - 100);
                    }
                }
                else if(liftLevel == 1){
                    if(avgDifference < 350){
                        ...
                        if (robot.liftMotor.getCurrentPosition() > 500) {
                            extensionOut(true, RobotConstants.rackRed - 150);
                        }
                    }
                    else{
        ...
        while (avgDifference < tick && opModeIsActive() && !stopMethod) {
            ...
            if(lift) {
                if(liftLevel == 2 || liftLevel == 3) {
                    liftUp(true, liftLevel);
                    if (robot.liftMotor.getCurrentPosition() > 300) {
                        extensionOut(true, RobotConstants.rackRed);
                    }
                }
                else if(liftLevel == 1){
                    if(avgDifference < 350){
                ...
                extensionOut(false, -60);
                if(Math.abs(robot.rackAndPinionMotor.getCurrentPosition()) > 150) {
                    liftUp(true, 3);
                }
                else{
                    //robot.liftMotor.setPower(0);
    ...
    public void intake(boolean on, boolean outtake){
        if(on) {
            ...
            robot.intakeMotor.setPower(-RobotConstants.intakeSpeed * 0.4);
            robot.LED.setState(true);
        }
        else{
            robot.intakeMotor.setPower(0);
