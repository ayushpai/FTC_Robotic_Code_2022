...
public class BlueVisionTest extends LinearOpMode
{
    ...
    public static class SkystoneDeterminationPipeline extends OpenCvPipeline
    {
        ...
        static Point REGION1_TOPLEFT_ANCHOR_POINT2 = new Point(RobotConstants.r2XBlue,RobotConstants.r1YBlue);
        static Point REGION1_TOPLEFT_ANCHOR_POINT3 = new Point(RobotConstants.r3XBlue,RobotConstants.r1YBlue);
