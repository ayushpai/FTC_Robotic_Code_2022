...
//@Config
//@Autonomous(name = "Blue Side Auto CYCLE", group = "Autonomous")
public class AutoBlue_CYCLE_OLD extends LinearOpMode {
    ...
    private void level1Auto(){
        strafeDirection(212, 0.4 , 690, true); // strafe back to duck
        duck(true); // turn duck motor on
        wait(3000);
        duck(false); // turn duck motor off
        wait(300);
        wait(8000); // 3839 delay
        strafeDirection(335, 0.7, 1800, true); // strafe left towards shipping hub
        strafeDirection(180, 0.3, 35,  true); // strafe left towards shipping hub

        

        strafeDirectionLIFT(270, 0.22, 75, true, 2, RobotConstants.rackRed -200);  //400 low //450 mid //480 high
        strafeDirection(270, 0.3, 50,  true); // strafe left towards shipping hub
        wait(1000);
        liftUp(false, 2);
        wait(1500);
        ...
        wait(1000);
        strafeDirection(90, 0.4, 1200, true);
        strafeDirection(0, 0.5, 2000, true);
    ...
    private void level2Auto(){
        ...
        wait(300);
        wait(8000); // 3839 delay
        strafeDirection(335, 0.7, 1800, true);
        wait(1000);// strafe left towards shipping hub
        strafeDirection(180, 0.3, 35,  true); // strafe left towards shipping hub

        strafeDirectionLIFT(270, 0.5, 300, true, 2, RobotConstants.rackRed -200);  //400 low //450 mid //480 high
        wait(1500);
        robot.clawServo.setPosition(RobotConstants.clawOpen);
        wait(1000);
        resetLiftExtension();
        wait(1000);
        strafeDirection(90, 0.4, 1300, true);
        strafeDirection(0, 0.5, 2000, true);
    }

    private void level3Auto(){
        strafeDirectionLIFT(113, 0.7 , 935, true, 3, RobotConstants.rackBlue - 50);
        wait(1500);
        robot.clawServo.setPosition(RobotConstants.clawOpen);
        wait(500);

        strafeDirection(293, 0.7, 935,  true); // strafe left towards shipping hub
        robot.clawServo.setPosition(RobotConstants.clawOpen);
        intake(true);

        //robot.rightCatEar.setPosition(RobotConstants.rightCatDown);
        strafeDirection(0, 0.5, 1800,  true);
        wait(1000);// strafe left towards shipping hub
        robot.clawServo.setPosition(RobotConstants.clawClose);
        strafeDirection(180, 0.7, 1800,  true); // strafe left towards shipping hub
        intake(false);
...
/*
        strafeDirection(68, 0.7, 935,  true); // strafe left towards shipping hub
        robot.clawServo.setPosition(RobotConstants.clawOpen);
        intake(true);
        //robot.rightCatEar.setPosition(RobotConstants.rightCatDown);
        strafeDirection(0, 0.5, 1900,  true);
        wait(3000);// strafe left towards shipping hub
        robot.clawServo.setPosition(RobotConstants.clawClose);
        strafeDirection(180, 0.7, 1800,  true); // strafe left towards shipping hub
        intake(false);
        robot.rightCatEar.setPosition(RobotConstants.rightCatUp);
        strafeDirectionLIFT(247, 0.7 , 935, true, 3, RobotConstants.rackRed);
        wait(1000);
        robot.clawServo.setPosition(RobotConstants.clawOpen);
        wait(1000);
        resetLiftExtension();
