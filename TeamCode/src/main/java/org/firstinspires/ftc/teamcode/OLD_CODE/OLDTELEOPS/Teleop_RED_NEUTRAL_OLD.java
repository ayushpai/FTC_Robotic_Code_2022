...
@TeleOp(name ="TELEOP RED NEUTRAL", group = "Teleop")
@Config
public class Teleop_RED_NEUTRAL_OLD extends OpMode {
    ...
    public void loop() {
        ...
        if(dpadUp){
            ...
            if(robot.liftMotor.getCurrentPosition() < 50){ // close the claw just in case to not break it
                clawOpen = false;
            }
            else if(robot.liftMotor.getCurrentPosition() > 50) {
